...
const SuggestTeamsInputSchema = z.object({
  players: z.array(
    z.object({
      ...
      totalGoals: z.number().describe('The total goals scored by the player.'),
...
const suggestTeamsPrompt = ai.definePrompt({
  ...
  Explain your reasoning for the team composition in the reasoning field. Be concise and clear.
